def call(String sendMail ,String url) {
    ...
    if(branchName == "Main")
    {
    mail mimeType: 'text/html' , body: html(subProjectName,branchName,url) , cc: 'devops.ebizzinfotech@gmail.com,coo.ebizzinfotech@gmail.com', from: "DevOps System", subject: "$projectName Project Build Failed... 😔", to: sendMail
    }
    else{
    mail mimeType: 'text/html' , body: html(subProjectName,branchName,url) , cc: '', from: "DevOps System", subject: "$projectName Project Build Failed... 😔", to: sendMail
    }
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        <h1
                                            ...
                                            $var_projectName Pipeline Failed.</h1>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
